...
const QUALITIES = ["2160p · 4K", "1440p · 2K", "1080p · HD", "720p", "480p", "360p"];
                ...
                >
                  {QUALITIES.map((q) => (
                    <button
                      ...
                      className="font-mono w-full text-left px-3 py-1.5 text-[12px] rounded-md hover:bg-white/10 transition-colors"
                      style={{
                        color: q === quality ? accent : "rgba(255,255,255,0.85)",
                      }}
                      data-testid={`quality-option-${q.split(" ")[0]}`}
                    >
                      {q}
                    </button>
                  ))}
